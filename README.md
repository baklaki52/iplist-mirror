...
[downstream-consumer](https://github.com/baklaki52/downstream-consumer).
...
downstream-consumer (`casino` excluded by policy).
...
fetching a blocklist). Operators who prefer zero outbound can pin downstream-consumer to
